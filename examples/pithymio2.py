...
if __name__ == '__main__':
    ...
    bus_obj=dbus.bus.BusConnection("tcp:host=localhost,port=33333")
    network = dbus.Interface(bus_obj.get_object('ch.epfl.mobots.Aseba', '/'), dbus_interface='ch.epfl.mobots.AsebaNetwork')
